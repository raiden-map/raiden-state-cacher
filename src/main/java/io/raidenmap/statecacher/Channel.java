...
public class Channel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    @Deprecated
    public long lastStateChangeBlock;
    @Deprecated
    public long settleTimeout;
    @Deprecated
    public io.raidenmap.statecacher.Participant firstParticipant;
    @Deprecated
    public io.raidenmap.statecacher.Participant secondParticipant;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                channelId = (java.lang.Integer) value$;
                break;
            case 1:
                state = (java.lang.CharSequence) value$;
                break;
            case 2:
                lastStateChangeBlock = (java.lang.Long) value$;
                break;
            case 3:
                settleTimeout = (java.lang.Long) value$;
                break;
            case 4:
                firstParticipant = (io.raidenmap.statecacher.Participant) value$;
                break;
            case 5:
                secondParticipant = (io.raidenmap.statecacher.Participant) value$;
                break;
            default:
                throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
    ...
    public Participant getParticipant(String address) {
        ...
        else if (getSecondParticipant().getEthAddress().toString().equals(address))

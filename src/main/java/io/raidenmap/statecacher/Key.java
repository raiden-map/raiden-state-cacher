...
public class Key extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static io.raidenmap.statecacher.Key.Builder newBuilder() {
    return new io.raidenmap.statecacher.Key.Builder();
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static io.raidenmap.statecacher.Key.Builder newBuilder(io.raidenmap.statecacher.Key.Builder other) {
    return new io.raidenmap.statecacher.Key.Builder(other);
  }
   ...
   * @return A new Key RecordBuilder
   */
  public static io.raidenmap.statecacher.Key.Builder newBuilder(io.raidenmap.statecacher.Key other) {
    return new io.raidenmap.statecacher.Key.Builder(other);
  }

...
public class TokenNetworkSnapshotEvent extends StateCacherEvent{
    ...
    private void consumeFromTokenNetworkDeltaTopic() {
        tokenNetworkSnapshotEventStream = builder.stream(Topics.tokenNetworkDelta, Consumed.with(specificSerdeManager.getKeySerde(), specificSerdeManager.getTokenNetworkDeltaSerde()))
        ...
        tokenNetworkSnapshotEventStream.to(Topics.tokenNetworkSnapshot, Produced.with(specificSerdeManager.getKeySerde(), specificSerdeManager.getTokenNetworkSnapshotSerde()));
    }
